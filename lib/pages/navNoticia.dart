...
class _navNoticiaState extends State<navNoticia> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.green, //ou 0xFF4CAF50
        leading: IconButton(
      ...
      body: ListView(
        padding: EdgeInsets.all(16.0),
          children: [
            ...
            _buildComentario("luiz.silva", "Que ridículo! É importante questionar...", "40min"),
            _buildComentario("marinait", "Nada a ver...", "2min", isReply: true),
          ],
      ),
    );
  }
