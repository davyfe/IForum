...
class _HometState extends State<Homet>{
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            leading: Padding(padding: EdgeInsets.only(left: 10), child: IconButton(
          ...
          SliverList.list(
            children: [
              buildPost(
                titulo: 'Estou fazendo uma reformulação da minha tela em dart!',
                autor: 'davyf',
                comunidade: 'devs.if',
                tempo: '30m',
                tipo: 'Material',
              ...
              buildPost(
                titulo: 'Tirei essa foto linda :P',
                autor: 'pdrolopesm',
                ...
                likes: 504,
                comentarios: 230,
                imagem: 'https://www.daninoce.com.br/wp-content/uploads/2017/07/9-vistas-incriveis-no-rio-de-janeiro-danielle-noce-imagem-destaque.jpg',
              ),
              buildPost(
  ...
  Widget buildPost({
    required titulo, required autor, required comunidade, required tempo, required tipo, tipo2, tipo3, conteudo='', likes=0, comentarios=0, anexo=false, imagem='' // pode até 3 tags!
}){
    return Column(
      children: [
        Container(
            ...
            children: [
              Row(
                children: [
                  ...
                  // SizedBox(width: 5),
                  Icon(Icons.chevron_right, size: 12, fontWeight: FontWeight.bold),
                  SizedBox(width: 3),
                  Text(comunidade, style: TextStyle(fontWeight: FontWeight.bold,)),
                  SizedBox(width: 10),
                  Text(tempo),
                  Spacer(),
              ...
              SizedBox(height: 5),
              Text(titulo, /*textAlign: TextAlign.justify,*/ style: TextStyle(
              ...
              //     SizedBox(width: 8),
              //     buildTags(tipo2),
              //     // pensando em ter tags apenas no post dentro da comunidade
              //     // posso adicionar mais...
              //   ],
              // ),
              if(conteudo.isNotEmpty)...[
                SizedBox(height: 5),
                Text(conteudo, maxLines: 3, overflow: TextOverflow.ellipsis),
              ],
              if(imagem.isNotEmpty)...[
                ...
                ClipRRect(
                  ...
                  child: Image.network(
                    imagem, width: double.infinity, fit: BoxFit.cover,
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Column(
                        children: [
                          Text('livro.pdf', style: TextStyle(
                            fontWeight: FontWeight.bold,
                          )),
              ...
              SizedBox(height: 8),
              buildInteracao(likes, comentarios),
            ],
          ),
        ),
  ...
  Widget buildTags(String tipo){
    return Chip(
      label: Text(tipo, style: TextStyle(
          fontWeight: FontWeight.bold, color: _getCor(tipo)
      )),
