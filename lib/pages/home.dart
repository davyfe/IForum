...
class _HomeState extends State<Home> {
  ...
  Widget _buildCabecalhoPost(PropriedadesPosts post) {
    return Row(
      children: [
  ...
  Color _getCor(String tipo) => switch (tipo.toLowerCase()) {
      'material' => Colors.indigo,
      'ajuda' => Colors.yellow.shade700,
      'dúvida' => Colors.red,
      'outros' => Colors.green,
      _ => Colors.grey,
    };
  ...
  Widget _buildChipInteracao({required Widget child}) {
    return Chip(
